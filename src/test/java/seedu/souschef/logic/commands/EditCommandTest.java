...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        EditCommand<UniqueType> editCommand = new EditCommand<UniqueType>(, , INDEX_FIRST_RECIPE, , descriptor);
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditCommand<UniqueType> editCommand = new EditCommand<UniqueType>(, , indexLastPerson, , descriptor);
    ...
    public void execute_filteredList_success() {
        ...
        EditCommand<UniqueType> editCommand = new EditCommand<UniqueType>(, ,
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        EditCommand<UniqueType> editCommand = new EditCommand<UniqueType>(, , INDEX_SECOND_RECIPE, , descriptor);
    ...
    public void execute_invalidPersonIndexUnfilteredList_failure() {
        ...
        EditCommand<UniqueType> editCommand = new EditCommand<UniqueType>(, , outOfBoundIndex, , descriptor);
    ...
    public void equals() {
        ...
        assertFalse(standardCommand.equals(new EditCommand<UniqueType>(, , INDEX_SECOND_RECIPE, , DESC_AMY)));

        // different descriptor -> returns false
        assertFalse(standardCommand.equals(new EditCommand<UniqueType>(, , INDEX_FIRST_RECIPE, , DESC_BOB)));*/
    }
